...
/*
function Dog(aname,acolor){
	this.name = aname;
	this.color = acolor;
}
var d = new Dog("kalor","pin");
//alert(d.properties().toString());
...
var tstr = "aaab";
alert(tstr.replace(r,"k"));
*/
// chapter  10 1.5
/*
var r1015 = /[Jj]ava([Ss]cript)?(?=\:)/;
var bookname = "JavaScript: The Definitive Guide";
alert(r1015.test(bookname));
alert(bookname.replace(r1015,"H"));
*/
